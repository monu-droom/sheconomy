...
$(document).ready(function () {
    ...
    if ($(".input-slider-container")[0]) {
        $(".input-slider-container").each(function () {
            ...
            var sliderId = document.getElementById("input-slider-range");
     ...
     // NoUI Slider ('Distance')
     if ($(".input-slider-container")[0]) {
        $(".input-slider-container").each(function () {
            var slider = $(this).find(".dist-input-slider");
            // var sliderId = slider.attr("id");
            var sliderId = document.getElementById("input-slider-range-dist");
            var minValue = slider.data("dist-range-value-min");
            var maxValue = slider.data("dist-range-value-max");

            var sliderValue = $(this).find(".range-slider-value-dist");
            var sliderValueId = sliderValue.attr("id");
            var startValue = sliderValue.data("dist-range-value-low");
    ...
    if ($("#input-slider-range-dist")[0]) {
        var i = document.getElementById("input-slider-range-dist"),
            j = document.getElementById("input-slider-range-dist-value-low"),
            k = document.getElementById("input-slider-range-dist-value-high"),
            l = [j, k];

        noUiSlider.create(i, {
            start: [
                parseInt(j.getAttribute("data-dist-range-value-low")),
                parseInt(k.getAttribute("data-dist-range-value-high")),
            ],
            connect: !0,
            range: {
                min: parseInt(i.getAttribute("data-dist-range-value-min")),
                max: parseInt(i.getAttribute("data-dist-range-value-max")),
            },
        }),
            i.noUiSlider.on("update", function (g, h) {
                l[h].textContent = g[h];
            }),
            i.noUiSlider.on("change", function (g, h) {
                rangeDistanceFilter(g);
            });
    }
