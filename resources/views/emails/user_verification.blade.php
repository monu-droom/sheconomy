<!-- This mail will trigger when user register and verification code will be sent -->
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://sheconomy.in/public/uploads/logo/nsDrluMIaWzxXm50ZxtOXaAJAp3AXfQLATMeh5CK.png" width="191" height="24" border="0" alt="" /></td>
																	</tr>
																</table>
															</th>
												...
												<td class="p30-15" style="padding: 70px 30px 70px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
                                                            ...
                                                            <td class="h5 center blue pb30" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; text-align:center; color:#2e57ae; padding-bottom:30px;">Welcome to SHEconomy. To activate your SHEconomy account you must first verify your email address by clicking this button below. </td>
														</tr>
                                                        @if(!empty( $array['link']))
                                                            <tr>
                                                                <td class="h5 center" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; text-align:center; color:#2e57ae; padding-bottom:30px;">
                                                            ...
                                                            <tr>
                                                                <td class="h5 center" style="font-family:'Ubuntu', Arial,sans-serif; font-size:20px; line-height:26px; padding-bottom:30px;">
																<h2>HAVING TROUBLE?</h2>

																<p style="font-size: 16px; color: #000;">If the link above did not work, you can copy and paste the full URL from your mail client into your web browser.</p>	
                                                                    <p style="font-size: 12px; color: #000;">{{ $array['link']}}</p>

																<h2>ADDITIONAL ASSISTANCE</h2>

																<p style="font-size: 16px; color: #000;">Thank you for choosing SHEconomy. If you need any kind of support please contact on support@sheconomy.in we will be happy to help you.</p>

																<strong><h3>Note:</h3></strong><p style="font-size: 16px; color: #000;">Please do not respond to this email, it does not accept incoming emails.</p><br>
