        ...
        <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                ...
                <td style="color: #153643; font-family: Arial, sans-serif;">
                    <h1 style="font-size: 24px; margin: 0;"> Your order #402-7466699-8957967 with Store Name of 1 item</h1>
                </td>
                </tr>
                <tr>
                <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                    <p style="display: flex; align-items: flex-end; float: right;">Order Confirmation <br>Order # 402-7466699-8957967</p>
                </td>
                </tr>
                <tr>
                  <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                     ...
                     <p style="margin: 0;">Thank you for your order. Congratulations on purchasing & paying directly from/to sellers on SHEconomy and promoting individual women owned / women lead businesses worldwide. 
                      Once the seller uploads shipping information on their website, you will get a confirmation of that your order has shipped. If you would like to view the status of your order or make any changes to it, please visit Your Orders on SHEconomy.in. </p>
                  </td>
                  </tr>
                  <tr>
                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                        ...
                        <p style="margin: 0;">Order #402-7466699-8957967 </p>
                        <p style="margin: 0;">Placed on Tuesday, November 17, 2020  </p>
                        <p style="margin: 0;">Item Subtotal: 	Rs. 799.00 </p>
                        <p style="margin: 0;">Shipping & Handling: 40</p>
                        <p style="margin: 0;">Order Total: 	Rs. 799.00 </p>
                      </td>
                    </tr>
                    <tr>
