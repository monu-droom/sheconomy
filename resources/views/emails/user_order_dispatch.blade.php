        ...
        <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                ...
                <td style="color: #153643; font-family: Arial, sans-serif;">
                    <h1 style="font-size: 24px; margin: 0;"> Your order #402-7466699-8957967 of 1 item has been dispatched.</h1>
                </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                     ...
                     <p style="margin: 0;">This is to let you know that your order has been shipped is on its way to you. Here are the tracking details for your order: </p>
                  </td>
                  </tr>
                  <tr>
                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                      <p style="margin: 0;">Tracking number & details: <br>
                        <p><strong>Order Code: </strong>#@php echo $array['code'] @endphp</p>
                        <p><strong>Date: </strong>#@php echo $array['date'] @endphp</p>
                        <p><strong>Product Name: </strong>@php echo $array['product_name'] @endphp</p>
                        <p><strong>Sold By: </strong>@php echo $array['seller_name'] @endphp</p>
                    </td>
                  </tr>
                  <tr>
                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
