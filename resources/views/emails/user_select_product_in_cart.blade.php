            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                ...
                <tr>
                  <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                     ...
                     <p style="margin: 0;">We noticed that you added one or more items to your sheconomy.in Shopping Cart, but didn't continue to Checkout. When you're ready to buy, simply visit your Shopping Cart to complete your order.</p>
                  </td>
                  </tr>
                  <tr>
                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                       <p style="margin: 0;">Samsung Galaxy M01 (Black, 3GB RAM, 32GB Storage) with No Cost... 
                        <br> by Samsung
                         </p>
                        <p style="margin: 0;">View Cart</p>
                    </td>
                    </tr>
                  <tr>
                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
