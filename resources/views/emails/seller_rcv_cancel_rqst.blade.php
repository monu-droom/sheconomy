              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                <tr>
                  <td style="color: #153643; font-family: Arial, sans-serif;">
                    <h1 style="font-size: 24px; margin: 0;">Your order 407-1884672-7805129 has been cancelled as per customer’s request</h1>
                  </td>
                </tr>
                <tr>
                  <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                    <p style="margin: 0;">Dear @php echo $array['seller_name'] @endphp,</p>
                    <p style="margin: 0;">Greetings from SHEconomy.</p>
                    <p style="margin: 0;">This email is to let you know that the customer has cancelled the order. You are requested to issue to not ship this order and issue a refund to your buyer. In case you have shipped the order already, please communicate with the buyer directly and agree on next steps to ensure your buyer’s needs are addressed adequately. Below are the details of the order:  </p>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <p style="margin: 0;">
                    <ul>
                      <li><strong>Order ID: </strong> @php echo $array['code'] @endphp</li>
                      <li><strong>Date: </strong> @php echo $array['date'] @endphp</li>
                      <li><strong>Name: </strong> @php echo $array['product_name'] @endphp</li>
