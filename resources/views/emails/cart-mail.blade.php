            ...
            <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                    ...
                    <td style="color: #153643; font-family: Arial, sans-serif;">
                        <h1 style="font-size: 24px; margin: 0;">Their is an item in your cart</h1>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                        <p style="margin: 0;">We noticed you left something in your cart</p>
                        <p><strong>Your Product Name: </strong>{{ $product_name }}</p>
                        <img src="https://sheconomy.in/public/{{ $product_image }}" style="width: 100px; height: 100px;" alt="">
                    </td>
                    </tr>
                    <tr>
                        <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                        <a href="https://sheconomy.in/cart" style="background: #007bff;padding: 0.9rem 2rem;font-size: 0.875rem;color:#fff;border-radius: .2rem;" target="_blank">{{ translate("Go To Cart") }}</a>
                        </td>
                    </tr>
                    <tr>
