            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                                ...
                                <ul class="collapse">
                                    ...
                                    @if(\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                        <li class="{{ areActiveRoutes(['products.seller', 'products.seller.edit'])}}">
                                            <a class="nav-link" href="{{route('products.seller')}}">{{translate('Seller Listing')}}</a>
                                        </li>
                                    @endif
                                    @if(\App\BusinessSetting::where('type', 'classified_product')->first()->value == 1)
                                        <li class="{{ areActiveRoutes(['classified_products'])}}">
                                            <a class="nav-link" href="{{route('classified_products')}}">{{translate('Business Listing')}}</a>
                                        </li>
                                    @endif
                                    <li class="{{ areActiveRoutes(['digitalproducts.index', 'digitalproducts.create', 'digitalproducts.edit'])}}">
                                        <a class="nav-link" href="{{route('digitalproducts.index')}}">{{translate('Digital Listing')}}</a>
                                    </li>
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="{{ areActiveRoutes(['order.tracking','order.tracking'])}}">
                            <a class="nav-link" href="{{ route('order.tracking') }}">
                                <i class="fa fa-money"></i>
                                <span class="menu-title">{{translate('Order Tracking')}}</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['all.seller.account.type'])}}">
                                    <a class="nav-link" href="{{ route('all.seller.account.type') }}">{{translate('Seller Account Type')}}</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['home.press','home_settings.index', 'home_banners.index', 'sliders.index', 'home_categories.index', 'home_banners.create', 'home_categories.create', 'home_categories.edit', 'sliders.create'])}}">
                                    <a class="nav-link" href="{{route('home.press')}}">{{translate('Press')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['home.blog','home_settings.index', 'home_banners.index', 'sliders.index', 'home_categories.index', 'home_banners.create', 'home_categories.create', 'home_categories.edit', 'sliders.create'])}}">
                                    <a class="nav-link" href="{{route('home.blog')}}">{{translate('Blog')}}</a>
                                </li>
                                <li>
                                    <a href="#">
