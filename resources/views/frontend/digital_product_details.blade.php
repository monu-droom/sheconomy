                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row align-items-center">
                                ...
                                @if (\App\BusinessSetting::where('type', 'conversation_system')->first()->value == 1)
                                    <div class="col-auto">
                                        <button class="btn btn-secondary" onclick="show_chat_modal()">{{ translate('Contact Service Provider')}}</button>
                                    </div>
                                @endif
                            </div>
                            ...
                            @if(home_price($detailedProduct->id) != home_discounted_price($detailedProduct->id))
                                ...
                                <div class="row no-gutters mt-3">
                                    <div class="col-2">
                                        <div class="product-description-label mt-1">{{ translate('Price')}}:</div>
                                    </div>
                                    <div class="col-10">
                            ...
                            <div class="d-table width-100 mt-3">
                                <div class="d-table-cell">
                                    <p style="box-shadow: 0px 0px 10px 2px #e83e8c; border-radius: 5px;font-family: Helvetica; font-size: 14px; padding: 5px;" class='payment-alert'>
                                      <strong style="color: #e8328c;"> <i class="fa fa-exclamation-triangle"></i> This supplier isn't accepting the payment right now. </strong>
                                ...
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        @if ($detailedProduct->user->seller->verification_status == 1)
                                            {{ translate('Verified Service Provider')}}
                                        @else
                                            {{ translate('Non verified service provider')}}
                                        @endif
                                    </div>
                                </div>
                            @endif
            ...
            <div class="row">
                <div class="col-xl-3 d-none d-xl-block">
                    ...
                    <div class="seller-top-products-box bg-white sidebar-box mb-3">
                        <div class="box-title">
                            {{ translate('Top Services From This Provider')}}
                        </div>
                    ...
                    <div class="my-4 bg-white p-3">
                        <div class="section-title-1">
                            <h3 class="heading-5 strong-700 mb-0">
                                <span class="mr-4">{{ translate('Related Services')}}</span>
                            </h3>
                        </div>
