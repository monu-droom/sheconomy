                ...
                <div class="row">
                    <div class="col-xl-3 side-filter d-xl-block">
                        ...
                        <div class="filter-wrapper c-scrollbar">
                            ...
                            <div class="bg-white sidebar-box mb-3">
                                <div class="box-title text-center">
                                    {{ translate('Distance range')}}
                                </div>
                                <div id="distance" class="box-content">
                                    <div class="dist-range-slider-wrapper mt-3">
                                        <!-- Range slider container -->
                                        <div
                                            id="input-slider-range-dist"
                                            data-dist-range-value-min="1"
                                            
                                            data-dist-range-value-max="20">
                                        </div>

                                        <!-- Range slider values -->
                                        <div class="row">
                                            <div class="col-6">
                                                <span class="range-slider-value-dist dist-value-low"
                                                    @if (isset($min_dist))
                                                    data-dist-range-value-low="{{ $min_dist }}"
                                                    @else
                                                    data-dist-range-value-low="0"
                                                    @endif
                                                    id="input-slider-range-dist-value-low">
                                            </div>

                                            <div class="col-6 text-right">
                                                <span class="range-slider-value-dist dist-value-high"
                                                    @if (isset($max_dist))
                                                    data-dist-range-value-high="{{ $max_dist }}"
                                                    @else
                                                    data-dist-range-value-high="0"
                                                    @endif
                                                    id="input-slider-range-dist-value-high">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white sidebar-box mb-3">
                                ...
                                <div class="box-content">
                                    ...
                                    <a class="color-collapsible">Choose Colors</a>
                                    <!-- Filter by color -->
                                    <div class="color-content mt-3">
                            ...
                            @foreach ($attributes as $key => $attribute)
                                @if (\App\Attribute::find($attribute['id']) != null)
                                    <div class="bg-white sidebar-box mb-3">
                                        ...
                                        <div class="box-content">
                                            <!-- Filter by others -->
                                            <a class="attr-collapsible">Choose {{ \App\Attribute::find($attribute['id'])->name }}</a>
                                            <div class="attr-content mt-3">
                                                ...
                                                @if(array_key_exists('values', $attribute))
                                                    @foreach ($attribute['values'] as $key => $value)
                                                        ...
                                                        <div class="checkbox">
                                                            ...
                                                            <label class="text-capitalize" for="attribute_{{ $attribute['id'] }}_value_{{ $value }}">{{ $value }}</label>
                                                        </div>
                                                    @endforeach
                                                @endif
                                            </div>
                    ...
                    <div class="col-xl-9">
                        <!-- <div class="bg-white"> -->
                            ...
                            <input type="hidden" name="min_dist" value="">
                            <input type="hidden" name="max_dist" value="">

                            <!-- <hr class=""> -->
                            <div class="products-box-bar p-3 bg-white">
                                <h4>Products</h4><hr style="height: 2px; border-width: 0; color: black; background-color: gray;">
                                ...
                                <?php $count = 0; ?>
                                        ...
                                        <div class="col-xxl-3 col-xl-4 col-lg-3 col-md-4 col-6">
                                            <div class="product-box-2 bg-white alt-box my-md-2">
                                                <div class="position-relative overflow-hidden">
                                                    @if($product->subsubcategory_id == 31)
                                                        <a href="{{ route('product', $product->slug) }}" class="d-block product-image h-100 text-center" tabindex="0">
                                                            <img class="img-fit lazyload" width="200" height="319" src="{{ static_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($product->thumbnail_img) }}" alt="{{  __($product->name) }}">
                                                        </a>
                                                    @else
                                                        <a href="{{ route('product', $product->slug) }}" class="d-block product-image h-100 text-center" tabindex="0">
                                    ...
                                    <div style="margin: 0 auto; text-align: center;">
                                        <h5 class='text-secondary'>No Product Found!</h5>
                                    </div>
                                    @endif
                                </div>
                            </div>
                            <div class="products-box-bar p-3 bg-white">
                                <hr><h4>Services</h4><hr style="height: 2px; border-width: 0; color: black; background-color: gray;">
                                <div class="row sm-no-gutters gutters-5">
                                <?php $count = 0;?>
                                    @foreach ($products as $key => $product)
                                    ...
                                    @if($count == 0)
                                    <div style="margin: 0 auto; text-align: center;">
                                        <h5 class='text-secondary'>No Service Found!</h5>
                                    </div>
                                    @endif
                                </div>
                            </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function rangeDistanceFilter(arg){
            console.log('distance');
            $('input[name=min_dist]').val(arg[0]);
            $('input[name=max_dist]').val(arg[1]);
            filterDistance();
        }
    </script>
<script>
var coll = document.getElementsByClassName("color-collapsible");
var i;
...
<script>
var coll = document.getElementsByClassName("attr-collapsible");
var i;
