                    ...
                    <div class="main-content">
                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="">{{ translate('Letter Heads')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="map-container">
                            ...
                            <button class="map-point-sm active" data-show=".one">
                                <div class="content">
                                    <div class="centered-y">
                                        <img style="height: 100px; width: 100px; border-radius: 8px;" onclick="getFirst()" src="{{ my_asset('cards/1_letter.jpg') }}" alt="" class="img-responsive">
                                    </div>
                                </div>
                            </button>
                            <button class="map-point-sm" data-show=".two">
                                <div class="content">
                                    <div class="centered-y">
                                        <img style="height: 100px; width: 100px; border-radius: 8px;" onclick="getSecond()" src="{{ my_asset('cards/2_letter.jpg') }}" alt="" class="img-responsive">
                                    </div>
                                </div>
                            </button>
                            <button class="map-point-sm" data-show=".three">
                                <div class="content">
                                    <div class="centered-y">
                                        <img style="height: 100px; width: 100px; border-radius: 8px;" onclick="getThird()" src="{{ my_asset('cards/3_letter.jpg') }}" alt="" class="img-responsive">
                                    </div>
                                </div>
                            </button>
                            <button class="map-point-sm" data-show=".four">
                                <div class="content">
                                    <div class="centered-y">
                                        <img style="height: 100px; width: 100px; border-radius: 8px;" onclick="getFourth();" src="{{ my_asset('cards/4_letter.jpg') }}" alt="" class="img-responsive">
                                    </div>
                                </div>
                            </button>
                            </div><!-- end inner basic -->
                    ...
                    <!--<div class="container mt-4">
                        ...
                        <div class="map-container">
                            <div class="inner-basic division-details">
                                ...
                                @if($seller->letter_head != '')
                                <div>
                                    <img src="{{ $seller->letter_head }}" alt="Your Letter Head" id="img">
                                </div>
                                <div class="mt-2">
                                    <a download="visiting-card.png" class="btn btn-danger" href="{{ $seller->letter_head }}">Download</a>
                                </div>    
                                @endif
                                            ...
                                            <meta name="csrf-token" content="{{ csrf_token() }}">
                                                <div class="row">
                                                    <div class="col-md-4 border-right">
                                                        ...
                                                        <div class="col-md-8">
                                                            <img id="no-crying_1" src="{{ my_asset('cards/1_letter.jpg') }}"/>
                                                            <div class="art-container scroll">
                                                                <!-- <canvas id="canvas"  height="800" width="600" ></canvas> -->
                                                                <canvas name="visiting_cards" height="800" width="600" id="c1"></canvas>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                        ...
                                        <div class="container border p-4">
                                            <div class="mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <img id="no-crying_2" src="{{ my_asset('cards/2_letter.jpg') }}"/>
                                                        <div class="art-container scroll">
                                                            <!-- <canvas id="canvas"  height="800" width="600" ></canvas> -->
                                                            <canvas name="visiting_cards[]" height="800" width="600" id="c2"></canvas>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="container border p-4">
                                            <div class="mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <img id="no-crying_3" src="{{ my_asset('cards/3_letter.jpg') }}"/>
                                                        <div class="art-container scroll">
                                                            <!-- <canvas id="canvas"  height="800" width="600" ></canvas> -->
                                                            <canvas height="800" width="600" id="c3"></canvas>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="container border p-4">
                                            <div class="mt-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <img id="no-crying_4" src="{{ my_asset('cards/4_letter.jpg') }}"/>
                                                        <div class="art-container scroll">
                                                            <!-- <canvas id="canvas"  height="800" width="600" ></canvas> -->
                                                            <canvas height="800" width="600" id="c4"></canvas>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        // USER IMPUT FUNCTIONS
            ...
            window.usertextChange2 = function(val2){
                ...
                context_1.font = '1 14px Helvetica';
                context_1.fillStyle = "#000";
                context_1.fillText(val2, 473, 694);
            ...
            function handleImage(e){
                ...
                reader.onload = function(event){
                    var img = new Image();
                    img.onload = function(){
                        context_1.drawImage(img,30, 30, 90, 90);
                    }
            ...
            $('#save1').click(function(){
                ...
                $.post('{{ route("saveLetterHead") }}', {_token:'{{ csrf_token() }}', image, success});
                if(success == 1){
                    alert('Your letter head is ready.');
        ...
        for(var n = 0; n < words_2.length; n++) {
            ...
            window.usertextChange6 = function(val){
                ...
                context_2.font = '14px Helvetica';
                context_2.fillStyle = "#000";
                context_2.fillText(val, 473, 694);
                wrapText(context_2, text1, x, y, maxWidth_2, lineHeight_2);
                } 
                ...
                function handleImage(e){
                    ...
                    reader_2.onload = function(event){
                        ...
                        img_2.onload = function(){
                            context_2.drawImage(img_2,240, 60, 90, 90);
                        }
        ...
        for(var n = 0; n < words_3.length; n++) {
            ...
            window.usertextChange10 = function(val){
                ...
                context_3.font = '14px Helvetica';
                context_3.fillStyle = "#000";
                context_3.fillText(val, 473, 694);
                wrapText(context_3, text1, x, y, maxWidth_3, lineHeight_3);
                } 
                ...
                function handleImage(e){
                    ...
                    reader_3.onload = function(event){
                        ...
                        img_3.onload = function(){
                            context_3.drawImage(img_3, 63, 16, 80, 80);
                        }
        ...
        <script>
            ...
            // USER IMPUT FUNCTIONS
                ...
                window.usertextChange14 = function(val){
                    ...
                    context_4.font = '14px Helvetica';
                    context_4.fillStyle = "#000";
                    context_4.fillText(val, 473, 694);
                    wrapText(context_4, text1, x, y, maxWidth_4, lineHeight_4);
                    } 
                ...
                function handleImage(e){
                    ...
                    reader_4.onload = function(event){
                        ...
                        img_4.onload = function(){
                            context_4.drawImage(img_4, 60, 27, 70, 70);
                        }
