...
@section('content')
    <div id="page-content">
        ...
        <?php 
            ...
            $product = \App\Product::where('id', $data['id'])->first();
                    ...
                    <div class="col-lg-8">
                        <form action="{{ route('payment.checkout') }}" class="form-default" data-toggle="validator" role="form" method="POST" id="checkout-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mx-auto">
                                            <div class="row">
                                                ...
                                                @endif
                                                @if($seller_payment->instamojo_status == 1 && $currency != 'USD')
                                                    <div class="col-6">
                                                ...
                                                @endif
                                                @if($seller_payment->razorpay_status == 1 && $currency != 'USD')
                                                    <div class="col-6">
                            ...
                            <div class="pt-3">
                                ...
                                <a href="{{ route('refundpolicy', $shop->user_id) }}">{{ translate('refund policy')}}</a> &
                                @endif
