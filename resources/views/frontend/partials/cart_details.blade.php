                                ...
                                @foreach (Session::get('cart') as $key => $cartItem)
                                    ...
                                    <tr class="cart-item">
                                        ...
                                        <td class="product-price d-none d-lg-table-cell">
                                            <span class="pr-3 d-block">{{ single_price($carts->price - $carts->tax) }}</span>
                                        </td>
                                            ...
                                            <div class="input-group input-group--style-2 pr-4" style="width: 130px;">
                                                <span class="input-group-btn">
                                                    <button class="btn btn-number" type="button" data-type="minus" data-field="quantity[{{ $key }}]">
                                                        ...
                                                        <input type="hidden" name="product_id" id="prod_id" value="{{$carts->product->id}}">
                                                <input type="text" name="quantity[{{ $key }}]" class="form-control h-auto input-number" placeholder="1" value="{{ $carts->quantity }}" min="1" max="10" onchange="updateQuantity({{ $key }}, this)">
                                                <span class="input-group-btn">
                                        ...
                                        <td class="product-total">
                                            <span>{{ single_price(($carts->price - $carts->tax) * $carts->quantity) }}</span>
                                        </td>
