            ...
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                ...
                <?php 
                    ...
                    if($user_country == 'india'){
                        $products = \App\Product::join('order_details as od', 'products.id', '=', 'od.product_id')
                                    ->join('shops', 'products.user_id', '=', 'shops.user_id')
                                    ->selectRaw('products.*, count(od.id) AS `od_count`')
                ...
                <div class="caorusel-box arrow-round gutters-5">
                    <div class="slick-carousel" data-slick-items="3" data-slick-lg-items="2"  data-slick-md-items="2" data-slick-sm-items="1" data-slick-xs-items="1" data-slick-rows="2">
                        @foreach (filter_products($products)->limit(20)->get() as $key => $product)
