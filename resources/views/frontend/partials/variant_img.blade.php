...
<div class="popup-gallery" id="{{isset($variant_images->variant) ? $variant_images->variant : ''}}">
<input type="hidden" name="check_variant" id='variant_exist' value="{{ isset($variant_images->variant) ? $variant_images->variant : '' }}">
@if(isset($variant_images->variant_img))
  <div class="product-gal sticky-top d-flex flex-row-reverse">
    ...
    <!-- <a href="{{ my_asset(json_decode($variant_images->variant_img)[0]) }}" id="theContent"> -->
        <img style="width: 100%;" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-toggle="modal" data-target="#largeModal" class="xzoom2 img-fluid lazyload img2 " src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset(json_decode($variant_images->variant_img)[0]) }}" xoriginal="{{ my_asset(json_decode($variant_images->variant_img)[0]) }}" />
      <!-- </a> -->
    </div>
