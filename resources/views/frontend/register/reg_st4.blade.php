...
<?php 
    ...
    $getShipping = \App\ShippingSetup::where('seller_id', $seller->id)->first();
    // dd($shipping);
?>
<style>
                    ...
                    <div class="main-content">
                        ...
                        <form class="form-default">
                            ...
                            <div class="text-center mt-4">
                                ...
                                <button type="submit" id="btn-show" class="btn btn-styled btn-base-1">{{ translate('Next')}}</button>
                            </div>
                            <br>
                        </form>    
                                    ...
                                    <tr id="{{$index}}}">
                                            ...
                                            <table>
                                                ...
                                                @foreach($rates as $key => $rate)
                                                    <td style="width: 120px;">
                                                        ...
                                                        ₹<input type="text" style="width: 40px" class="row-data" name="{{$key}}" value='{{ceil(str_replace(",", "", $rate))}}'>
                                                    </td>
                                                @endforeach
                                                </tr>
                                                </tbody>
                                        ...
                                        <td>
                                            <table>
                                                ...
                                                <tbody> 
                                                <?php
                                                    $rate = json_decode($ship->rate_weight, true);
                                                ?>       
                                                <tr class="d-flex">
