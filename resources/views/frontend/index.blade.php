...
@section('content')
        ...
        <div class="container">
            <div class="row no-gutters position-relative">
                <div class="col-lg-3 position-static order-2 order-lg-0">
                    <div class="category-sidebar">
                        ...
                        <ul class="categories no-scrollbar">
                            ...
                            @foreach (\App\Category::where('digital', 1)->get()->take(12) as $key => $category)
                                @php
                                    $brands = array();
                                @endphp
                ...
                @php
                    ...
                    $services = \App\Category::where('digital', 0)->get();
                @endphp
                ...
                <div class="@if($num_todays_deal > 0) col-lg-7 @else col-lg-9 @endif order-1 order-lg-0 @if(count($featured_categories) == 0) home-slider-full @endif">
                    ...
                    <div class="caorusel-box arrow-round gutters-5">
                        <div class="slick-carousel" data-slick-items="6" data-slick-xl-items="7" data-slick-lg-items="4"  data-slick-md-items="3" data-slick-sm-items="2" data-slick-xs-items="2">
                            @foreach ($services->take(8) as $key => $category)
                            <div class="caorusel-card">
                                <div class="product-card-2 card card-product shop-cards shop-tech">
                                    <div class="card-body p-0">

                                        <div class="card-image">
                                        <div @if ($key == 0) class="active" @endif>
   ...
   @endif
    ...
    <?php 
        $categories = \App\Category::join('products as p', 'categories.id', '=', 'p.category_id')
                    ->join('order_details as od', 'p.id', '=', 'od.product_id')
                    ->selectRaw('categories.*, count(od.id) AS `od_count`')
            ...
            <div class="row gutters-10">
                <div class="col-lg-6">
                    ...
                    <div class="row gutters-5">
                        @foreach ($categories->take(10)->get() as $category)
                ...
                <?php 
                    $brands = \App\Brand::join('products as p', 'brands.id', '=', 'p.brand_id')
                                ->join('order_details as od', 'p.id', '=', 'od.product_id')
                                ->selectRaw('brands.*, count(od.id) AS `od_count`')
                                ->where('od.payment_status', 'paid')
                                ->groupBy('p.id')         
                                ->orderBy('p.rating', 'DESC')
                                ->orderBy('od_count', 'DESC')
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row gutters-5">
                        @foreach ($brands->take(10)->get() as $brand)
                            <div class="mb-3 col-6">
