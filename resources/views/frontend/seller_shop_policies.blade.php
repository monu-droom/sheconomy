...
@section('content')
    ...
    <section class="@if (!isset($type)) gry-bg @endif pt-5">
        <!-- <div class="container">
            <h4 class="heading-5 strong-600 border-bottom pb-3 mb-2">
                {{ translate ('Refund Policy')}}               
            </h4>
            <div class="product-list row gutters-5 sm-no-gutters mb-4">
                {{ $shop->refund_policy}}
            </div>
            <h4 class="heading-5 strong-600 border-bottom pb-3 mb-2">
    ...
    <div class="card">
      <div class="card-header">
        <a class="card-link" data-toggle="collapse" href="#collapseOne">
          <h5>{{ translate('Refund Policy')}}</h5>
        </a>
      </div>
      <div id="collapseOne" class="collapse show" data-parent="#accordion">
        <div class="card-body">
            <?php echo $shop->refund_policy; ?>
        </div>
      </div>
    </div>
    @if($shop->seller_type == 'goods' || $shop->seller_type == 'both')
    <div class="card">
      <div class="card-header">
        <a class="collapsed card-link" data-toggle="collapse" href="#collapseTwo">
            <h5>{{ translate('Shipping Policy')}}</h5>
      </a>
      </div>
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
        <div class="card-body">
            <?php echo $shop->shipping_policy; ?>
        </div>
      </div>
    </div>
    @endif
    <div class="card mb-4">
      <div class="card-header">
        <a class="collapsed card-link" data-toggle="collapse" href="#collapseThree">
          <h5>{{ translate('Payment Policy') }}</h5>
        </a>
      </div>
      <div id="collapseThree" class="collapse" data-parent="#accordion">
        <div class="card-body">
          <?php echo $shop->payment_policy; ?>
        </div>
      </div>
    </div>
  </div>
