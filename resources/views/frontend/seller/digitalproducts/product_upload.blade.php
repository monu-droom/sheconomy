                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        {{translate('Add Your Service Product')}}
                                    </h2>
                                </div>
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li><a href="{{ route('seller.digitalproducts') }}">{{translate('Service Listing')}}</a></li>
                                            <li class="active"><a href="{{ route('seller.digitalproducts.upload') }}">{{ translate('Add New Service')}}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="" action="{{route('digitalproducts.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                ?>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Service Price') }} <span class="required-star">* </span><small style="font-size: 10px;">(Included tax)</small></label>
                                        </div>
                                        <div class="col-md-5">
                                        <input type="number" min="0" class="form-control mb-3" name="unit_price_ei" value="{{ old('unit_price_ei') }}" placeholder="{{ translate('Unit Price In INR') }}" required>
                                        ...
                                        <div class="col-md-5">
                                        <input type="number" min="0" class="form-control mb-3" name="unit_price_nei" value="{{ old('unit_price_nei') }}" placeholder="{{ translate('Unit Price In USD') }}" required>
                                            <a type="button" class="text-danger ibutton" data-toggle="popover" data-content="<p>Enter the price of product in this listing. You may include additional shipping cost not covered when using the shipping calculator section of seller dashboard (shipping calculator section of dashboard allows you to charge one fixed shipping rate for all your listings irrespective of size and weight in each seperate listing).</p>"><i class="fa fa-question-circle"></i></a>
                                        </div>
                                    </div>
                                    <!-- <div class="row">
