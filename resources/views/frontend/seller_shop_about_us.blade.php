...
@section('content')
    ...
    <section class="@if (!isset($type)) gry-bg @endif pt-5">
        <div class="container">
            ...
            <div style="padding:5px;" class="product-list row gutters-5 sm-no-gutters">
                <?php echo $shop->about ?>
            </div>
            <h4 class="heading-5 strong-600 border-bottom pb-3 mb-4">                
                  QR Code
            </h4>
            <span style="padding:5px;" class="product-list row gutters-5 sm-no-gutters"> For A Quick Visit Of Your Store </span>
            <div style="padding:5px;" class="product-list row gutters-5 sm-no-gutters">{{ $qr_code }}</div>
            <div class="row">
                <div class="col">
