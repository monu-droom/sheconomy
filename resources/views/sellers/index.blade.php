                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="status" style='color:green;'>
                                    <strong>{{translate('Status : '.ucfirst($seller->kyc_status))}}</strong>
                                </div>
                                @elseif($seller->kyc_status == 'submitted')
                                ...
                                @endif
                                @if ($seller->kyc_status == 'rejected' || $seller->kyc_status == 'verified')
                                ...
                                @endif
                                @if ($seller->kyc_status == 'submitted')
                                    <a href="{{ route('sellers.show_verification_request', $seller->id) }}">
                                        <div class="label label-table label-info">
                                            {{translate('verify')}}
                                        </div>
